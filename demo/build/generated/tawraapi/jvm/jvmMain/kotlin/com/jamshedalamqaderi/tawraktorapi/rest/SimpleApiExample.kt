...
public fun Route.simpleApiExample(): Unit {
  route("""/api"""){
  	val simpleApiExample = com.jamshedalamqaderi.tawraktorapi.demo.SimpleApiExample()
  get("""/findAll/{task_id}"""){

      val multipartData = call.receiveMultipart()

      val multipartMap =
          com.jamshedalamqaderi.tawraktorapi.api.RequestDataHandler.handleMultipartData("""upload/""",
          multipartData)
  call.respond(
  simpleApiExample.findAllData(
  call.parameters["""task_id"""]?.toIntOrNull(),
  call.request.queryParameters["""name"""],
  com.jamshedalamqaderi.tawraktorapi.demo.MultipartModel(
